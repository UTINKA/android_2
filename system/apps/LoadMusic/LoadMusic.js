android.Apps.InitApp('LoadMusic', function() // Update Second
{
	var MPApp = $('.music_app');
...
}, function() // Open
{
	...
	var img_url = 'url(' + android.location_device + 'system/apps/LoadMusic/res/music.png)';
	...
	MPApp_Content.find('.content_load_music .load_music_button .form-group #file').change(function(e)
	{
		...
		android.UI.setMediaDataPlayer(
			android.Media.Audio[2], 
			android.location_device + 'system/apps/LoadMusic/res/music.png',
			"",
			name,
			'rgb(204, 0, 72)'
		);
